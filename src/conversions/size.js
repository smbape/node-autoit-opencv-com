...
module.exports = (header = [], impl = [], options = {}) => {
    header.push(`
        ...
        template<typename _Tp>
        inline const bool is_assignable_from(AUTOIT_PTR<cv::Size_<_Tp>>& out_val, VARIANT const* const& in_val, bool is_optional) {
        ...
        template<typename _Tp>
        inline const HRESULT autoit_to(VARIANT const* const& in_val, AUTOIT_PTR<cv::Size_<_Tp>>& out_val) {
