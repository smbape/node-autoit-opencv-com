...
;~     https://github.com/opencv/opencv/blob/4.13.0/samples/dnn/object_detection.py
...
Func UpdateZooModel()
	...
	Local $aSearchPaths[] = [ _
			...
			"opencv-4.13.0-*\sources\samples\dnn", _
			"opencv-4.13.0-*\sources\samples\data\dnn", _
			"opencv-4.13.0-*\opencv\sources\samples\dnn", _
			"opencv-4.13.0-*\opencv\sources\samples\data\dnn" _
			]
