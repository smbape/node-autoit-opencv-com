...
;~ Sources:
;~     https://docs.opencv.org/4.8.0/da/d97/tutorial_threshold_inRange.html
;~     https://github.com/opencv/opencv/blob/4.8.0/samples/cpp/tutorial_code/ImgProc/Threshold_inRange.cpp
