...
;~ Sources:
;~     https://docs.opencv.org/4.12.0/d3/dc1/tutorial_basic_linear_transform.html
;~     https://github.com/opencv/opencv/blob/4.12.0/samples/cpp/tutorial_code/ImgProc/changing_contrast_brightness_image/changing_contrast_brightness_image.cpp
...
Global $InputSource = GUICtrlCreateInput($cv.samples.findFile("lena.jpg"), 366, 16, 449, 21)
...
Func basicLinearTransform()
	...
	Local $res = $cv.convertScaleAbs($img, _OpenCV_Params("alpha", $alpha, "beta", $beta))
