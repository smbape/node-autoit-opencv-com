...
;~ Sources:
;~     https://docs.opencv.org/4.8.0/dc/dd3/tutorial_gausian_median_blur_bilateral_filter.html
;~     https://github.com/opencv/opencv/blob/4.8.0/samples/cpp/tutorial_code/ImgProc/Smoothing/Smoothing.cpp
