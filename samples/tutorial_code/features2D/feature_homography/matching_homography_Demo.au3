...
;~ Sources:
;~     https://docs.opencv.org/4.10.0/d7/dff/tutorial_feature_homography.html
;~     https://github.com/opencv/opencv/blob/4.10.0/samples/cpp/tutorial_code/features2D/feature_homography/SURF_FLANN_matching_homography_Demo.cpp
...
Global $InputObject = GUICtrlCreateInput($cv.samples.findFile("box.png"), 230, 16, 449, 21)
Global $BtnObject = GUICtrlCreateButton("Object", 689, 14, 75, 25)

Global $InputScene = GUICtrlCreateInput($cv.samples.findFile("box_in_scene.png"), 230, 52, 449, 21)
