...
;~ Sources:
;~     https://docs.opencv.org/4.13.0/db/d70/tutorial_akaze_matching.html
;~     https://github.com/opencv/opencv/blob/4.13.0/samples/cpp/tutorial_code/features2D/AKAZE_match.cpp
