...
;~ Sources:
;~     https://docs.opencv.org/4.11.0/db/d70/tutorial_akaze_matching.html
;~     https://github.com/opencv/opencv/blob/4.11.0/samples/cpp/tutorial_code/features2D/AKAZE_match.cpp
...
Global $InputImg1 = GUICtrlCreateInput($cv.samples.findFile("graf1.png"), 230, 16, 449, 21)
Global $BtnImg1 = GUICtrlCreateButton("Image 1", 689, 14, 75, 25)

Global $InputImg2 = GUICtrlCreateInput($cv.samples.findFile("graf3.png"), 230, 52, 449, 21)
Global $BtnImg2 = GUICtrlCreateButton("Image 2", 689, 50, 75, 25)

Global $InputHomography = GUICtrlCreateInput($cv.samples.findFile("H1to3p.xml"), 230, 92, 449, 21)
