...
;~ Sources:
;~     https://docs.opencv.org/4.9.0/da/d7f/tutorial_back_projection.html
;~     https://github.com/opencv/opencv/blob/4.9.0/samples/cpp/tutorial_code/Histograms_Matching/calcBackProject_Demo1.cpp
