...
;~ Sources:
;~     https://docs.opencv.org/4.8.0/d8/dbc/tutorial_histogram_calculation.html
;~     https://github.com/opencv/opencv/blob/4.8.0/samples/cpp/tutorial_code/Histograms_Matching/calcHist_Demo.cpp
