...
;~ Sources:
;~     https://docs.opencv.org/4.8.0/d8/dc8/tutorial_histogram_comparison.html
;~     https://github.com/opencv/opencv/blob/4.8.0/samples/cpp/tutorial_code/Histograms_Matching/compareHist_Demo.cpp
