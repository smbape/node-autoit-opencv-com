...
;~ Sources:
;~     https://docs.opencv.org/4.9.0/d8/dc8/tutorial_histogram_comparison.html
;~     https://github.com/opencv/opencv/blob/4.9.0/samples/cpp/tutorial_code/Histograms_Matching/compareHist_Demo.cpp
...
Global $InputSrcTest1 = GUICtrlCreateInput($cv.samples.findFile("Histogram_Comparison_Source_1.jpg"), 230, 52, 449, 21)
Global $BtnSrcTest1 = GUICtrlCreateButton("Input 2", 689, 50, 75, 25)

Global $InputSrcTest2 = GUICtrlCreateInput($cv.samples.findFile("Histogram_Comparison_Source_2.jpg"), 230, 88, 449, 21)
