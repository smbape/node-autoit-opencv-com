...
;~ Sources:
;~     https://docs.opencv.org/4.13.0/d4/d1b/tutorial_histogram_equalization.html
;~     https://github.com/opencv/opencv/blob/4.13.0/samples/cpp/tutorial_code/Histograms_Matching/EqualizeHist_Demo.cpp
