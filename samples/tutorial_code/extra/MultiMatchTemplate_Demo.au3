...
;~ Sources:
;~     https://docs.opencv.org/4.12.0/d4/dc6/tutorial_py_template_matching.html
...
Global $InputSource = GUICtrlCreateInput($cv.samples.findFile("mario.png"), 185, 16, 449, 21)
Global $BtnSource = GUICtrlCreateButton("Source", 644, 14, 75, 25)

Global $InputTemplate = GUICtrlCreateInput($cv.samples.findFile("mario_coin.png"), 185, 52, 449, 21)
...
; ControlSetText($FormGUI, "", $InputSource, $cv.samples.findFile("lena_tmpl.jpg"))
; ControlSetText($FormGUI, "", $InputTemplate, $cv.samples.findFile("tmpl.png"))
; ControlSetText($FormGUI, "", $InputMask, $cv.samples.findFile("mask.png"))
