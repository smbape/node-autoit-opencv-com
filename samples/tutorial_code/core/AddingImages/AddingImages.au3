...
;~ Sources:
;~     https://docs.opencv.org/4.12.0/d5/dc4/tutorial_adding_images.html
;~     https://github.com/opencv/opencv/blob/4.12.0/samples/cpp/tutorial_code/core/AddingImages/AddingImages.cpp
