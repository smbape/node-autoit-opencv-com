...
;~ Sources:
;~     https://docs.opencv.org/4.10.0/d8/d01/tutorial_discrete_fourier_transform.html
;~     https://github.com/opencv/opencv/blob/4.10.0/samples/cpp/tutorial_code/core/discrete_fourier_transform/discrete_fourier_transform.cpp
