...
## Installation
  ...
  - Download and extract [opencv-4.13.0-windows.exe](https://github.com/opencv/opencv/releases/) into a folder
  - Download and extract [autoit-opencv-4.13.0-com-v2.8.0.7z](https://github.com/smbape/node-autoit-opencv-com/releases/download/v2.8.0/autoit-opencv-4.13.0-com-v2.8.0.7z) into a folder
...
# download autoit-opencv-4.13.0-com-v2.8.0.7z
curl -L 'https://github.com/smbape/node-autoit-opencv-com/releases/download/v2.8.0/autoit-opencv-4.13.0-com-v2.8.0.7z' -o autoit-opencv-4.13.0-com-v2.8.0.7z

# extract the content of autoit-opencv-4.13.0-com-v2.8.0.7z into a folder named autoit-opencv-com
7z x autoit-opencv-4.13.0-com-v2.8.0.7z -aoa -oautoit-opencv-com
...
# download autoit-opencv-4.13.0-com-v2.8.0-src.zip
curl -L 'https://github.com/smbape/node-autoit-opencv-com/archive/refs/tags/v2.8.0.zip' -o autoit-opencv-4.13.0-com-v2.8.0-src.zip

# extract the autoit-addon and samples folders of autoit-opencv-4.13.0-com-v2.8.0-src.zip
7z x autoit-opencv-4.13.0-com-v2.8.0-src.zip -aoa 'node-autoit-opencv-com-2.8.0\autoit-addon\*' 'node-autoit-opencv-com-2.8.0\samples\*'
...
The translation usually involves 2 steps:
  ...
  - Transform the parameter types according to the UDF parameter. This step might involve looking at the [opencv documentation](https://docs.opencv.org/4.13.0/index.html).
...
The [GaussianBlur](https://docs.opencv.org/4.13.0/d4/d86/group__imgproc__filter.html#gaabe8c836e97159a9193fb0b11ac52cf1) documentation gives the following information
```txt
...
The [threshold](https://docs.opencv.org/4.13.0/d7/d1b/group__imgproc__misc.html#gae8a4a146d1ca78c626a53577199e9c57) documentation gives the following information
```txt
...
The [findContours](https://docs.opencv.org/4.13.0/d3/dc0/group__imgproc__shape.html#gadf1ad6a0b82947fa1fe3c3d497f260e0) documentation gives the following information
```txt
