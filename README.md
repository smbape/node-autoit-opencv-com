...
## Prerequisites
  ...
  - Download and extract [autoit-opencv-4.6.0-com-v2.2.1.7z](https://github.com/smbape/node-autoit-opencv-com/releases/download/v2.2.1/autoit-opencv-4.6.0-com-v2.2.1.7z) into a folder
...
# download autoit-opencv-4.6.0-com-v2.2.1-src.zip
curl -L 'https://github.com/smbape/node-autoit-opencv-com/archive/refs/tags/v2.2.1.zip' -o autoit-opencv-4.6.0-com-v2.2.1-src.zip

# extract the autoit-addon and samples folders of autoit-opencv-4.6.0-com-v2.2.1-src.zip
7z x autoit-opencv-4.6.0-com-v2.2.1-src.zip -aoa 'node-autoit-opencv-com-2.2.1\autoit-addon\*' 'node-autoit-opencv-com-2.2.1\samples\*'
cp -rf node-autoit-opencv-com-2.2.1/* ./
rm -rf node-autoit-opencv-com-2.2.1
```
