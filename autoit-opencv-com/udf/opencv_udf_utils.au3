...
Func _OpenCV_FindDLL($sFile, $sFilter = Default, $sDir = Default, $bReverse = Default)
	...
	Local $aSearchPaths[] = [ _
			...
			"opencv-4.9.0-*\build\x64\vc16\bin", _
			"opencv-4.9.0-*\opencv\build\x64\vc16\bin" _
			]
...
; Author ........: Stéphane MBAPE
; Modified ......:
; Remarks .......: https://github.com/opencv/opencv/blob/4.9.0/modules/highgui/src/window_w32.cpp#L1407
;                  https://github.com/opencv/opencv/blob/4.9.0/modules/highgui/src/window_w32.cpp#L122
; ===============================================================================================================================
...
;                  https://github.com/opencv/opencv/blob/4.9.0/samples/cpp/tutorial_code/Histograms_Matching/MatchTemplate_Demo.cpp#L84
