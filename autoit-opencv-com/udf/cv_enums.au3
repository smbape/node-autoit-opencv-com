...
; PutTextFlags
Global Const $CV_PUT_TEXT_ALIGN_LEFT = 0
Global Const $CV_PUT_TEXT_ALIGN_CENTER = 1
Global Const $CV_PUT_TEXT_ALIGN_RIGHT = 2
Global Const $CV_PUT_TEXT_ALIGN_MASK = 3
Global Const $CV_PUT_TEXT_ORIGIN_TL = 0
Global Const $CV_PUT_TEXT_ORIGIN_BL = 32
Global Const $CV_PUT_TEXT_WRAP = 128
...
Global Const $CV_STEREO_ZERO_DISPARITY = 0x00400
...
; MatrixType
Global Const $CV_MATRIX_TYPE_AUTO = 0
Global Const $CV_MATRIX_TYPE_DENSE = 1
Global Const $CV_MATRIX_TYPE_SPARSE = 2

; VariableType
Global Const $CV_VARIABLE_TYPE_LINEAR = 0
Global Const $CV_VARIABLE_TYPE_SO3 = 1
Global Const $CV_VARIABLE_TYPE_SE3 = 2
...
; RgbdNormalsMethod
Global Const $CV_RGBD_NORMALS_RGBD_NORMALS_METHOD_FALS = 0
Global Const $CV_RGBD_NORMALS_RGBD_NORMALS_METHOD_LINEMOD = 1
Global Const $CV_RGBD_NORMALS_RGBD_NORMALS_METHOD_SRI = 2

; RgbdPlaneMethod
Global Const $CV_RGBD_PLANE_METHOD_DEFAULT = 0

; OdometryType
Global Const $CV_DEPTH = 0
Global Const $CV_RGB = 1
Global Const $CV_RGB_DEPTH = 2

; OdometryAlgoType
Global Const $CV_ODOMETRY_ALGO_TYPE_COMMON = 0
Global Const $CV_ODOMETRY_ALGO_TYPE_FAST = 1

; OdometryFramePyramidType
Global Const $CV_PYR_IMAGE = 0
Global Const $CV_PYR_DEPTH = 1
Global Const $CV_PYR_MASK = 2
Global Const $CV_PYR_CLOUD = 3
Global Const $CV_PYR_DIX = 4
Global Const $CV_PYR_DIY = 5
Global Const $CV_PYR_TEXMASK = 6
Global Const $CV_PYR_NORM = 7
Global Const $CV_PYR_NORMMASK = 8
Global Const $CV_N_PYRAMIDS = 8 + 1

; OdometryFrameStoreType
Global Const $CV_ODOMETRY_FRAME_STORE_TYPE_MAT = 0
Global Const $CV_ODOMETRY_FRAME_STORE_TYPE_UMAT = 1

; SacMethod
Global Const $CV_SAC_METHOD_RANSAC = 0

; SacModelType
Global Const $CV_SAC_MODEL_PLANE = 0
Global Const $CV_SAC_MODEL_SPHERE = 1

; VolumeType
Global Const $CV_VOLUME_TYPE_TSDF = 0
Global Const $CV_VOLUME_TYPE_HashTSDF = 1
Global Const $CV_VOLUME_TYPE_ColorTSDF = 2
...
Global Const $CV_DETAIL_OPAQUE_KIND_CV_SIZE = 10
Global Const $CV_DETAIL_OPAQUE_KIND_CV_RECT = 11
Global Const $CV_DETAIL_OPAQUE_KIND_CV_SCALAR = 12
