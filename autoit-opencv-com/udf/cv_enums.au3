...
Global Const $CV__INPUT_ARRAY_CUDA_GPU_MATND = BitShift(16, -$CV__INPUT_ARRAY_KIND_SHIFT)
...
; cv::instr::TYPE
Global Const $CV_INSTR_TYPE_GENERAL = 0
Global Const $CV_INSTR_TYPE_MARKER = 0 + 1
Global Const $CV_INSTR_TYPE_WRAPPER = 0 + 2
Global Const $CV_INSTR_TYPE_FUN = 0 + 3

; cv::instr::IMPL
Global Const $CV_INSTR_IMPL_PLAIN = 0
Global Const $CV_INSTR_IMPL_IPP = 0 + 1
Global Const $CV_INSTR_IMPL_OPENCL = 0 + 2

; cv::instr::FLAGS
Global Const $CV_INSTR_FLAGS_NONE = 0
Global Const $CV_INSTR_FLAGS_MAPPING = 0x01
Global Const $CV_INSTR_FLAGS_EXPAND_SAME_NAMES = 0x02

; cv::utils::logging::LogLevel
Global Const $CV_UTILS_LOGGING_LOG_LEVEL_SILENT = 0
Global Const $CV_UTILS_LOGGING_LOG_LEVEL_FATAL = 1
Global Const $CV_UTILS_LOGGING_LOG_LEVEL_ERROR = 2
Global Const $CV_UTILS_LOGGING_LOG_LEVEL_WARNING = 3
Global Const $CV_UTILS_LOGGING_LOG_LEVEL_INFO = 4
Global Const $CV_UTILS_LOGGING_LOG_LEVEL_DEBUG = 5
Global Const $CV_UTILS_LOGGING_LOG_LEVEL_VERBOSE = 6
Global Const $CV_UTILS_LOGGING_ENUM_LOG_LEVEL_FORCE_INT = 0x7FFFFFFF
...
Global Const $CV_IMWRITE_PNG_ZLIBBUFFER_SIZE = 20
...
Global Const $CV_IMWRITE_BMP_COMPRESSION = 768
...
; cv::ImwriteTiffResolutionUnitFlags
Global Const $CV_IMWRITE_TIFF_RESOLUTION_UNIT_NONE = 1
Global Const $CV_IMWRITE_TIFF_RESOLUTION_UNIT_INCH = 2
Global Const $CV_IMWRITE_TIFF_RESOLUTION_UNIT_CENTIMETER = 3
...
; cv::ImwriteBMPCompressionFlags
Global Const $CV_IMWRITE_BMP_COMPRESSION_RGB = 0
Global Const $CV_IMWRITE_BMP_COMPRESSION_BITFIELDS = 3
...
Global Const $CV_IMAGE_METADATA_CICP = 3
Global Const $CV_IMAGE_METADATA_MAX = 3
...
Global Const $CV_VIDEO_ACCELERATION_DRM = 5
...
Global Const $CV_CAP_PROP_OBSENSOR_RGB_POS_MSEC = 26005
Global Const $CV_CAP_PROP_OBSENSOR_DEPTH_POS_MSEC = 26006
Global Const $CV_CAP_PROP_OBSENSOR_DEPTH_WIDTH = 26007
Global Const $CV_CAP_PROP_OBSENSOR_DEPTH_HEIGHT = 26008
Global Const $CV_CAP_PROP_OBSENSOR_DEPTH_FPS = 26009
Global Const $CV_CAP_PROP_OBSENSOR_COLOR_DISTORTION_K1 = 26010
Global Const $CV_CAP_PROP_OBSENSOR_COLOR_DISTORTION_K2 = 26011
Global Const $CV_CAP_PROP_OBSENSOR_COLOR_DISTORTION_K3 = 26012
Global Const $CV_CAP_PROP_OBSENSOR_COLOR_DISTORTION_K4 = 26013
Global Const $CV_CAP_PROP_OBSENSOR_COLOR_DISTORTION_K5 = 26014
Global Const $CV_CAP_PROP_OBSENSOR_COLOR_DISTORTION_K6 = 26015
Global Const $CV_CAP_PROP_OBSENSOR_COLOR_DISTORTION_P1 = 26016
Global Const $CV_CAP_PROP_OBSENSOR_COLOR_DISTORTION_P2 = 26017
