...
:mainmenu
@SET DLLDIRNAME=
@SET DLLNAME=autoit_opencv_com4120%DEBUG_PREFIX%.dll

@IF EXIST "%CD%\build_x64\%INT_DIR%\%DLLNAME%" @SET "DLLDIRNAME=%CD%\build_x64\%INT_DIR%\"
@IF EXIST "%CD%\..\opencv-4.12.0-windows\opencv\build\x64\vc16\bin" @SET "PATH=%CD%\..\opencv-4.12.0-windows\opencv\build\x64\vc16\bin;%PATH%"
